...
-- CreateIndex
CREATE UNIQUE INDEX "exchange_keys_userId_exchange_key" ON "exchange_keys"("userId", "exchange");
...
-- AddForeignKey
ALTER TABLE "exchange_keys" ADD CONSTRAINT "exchange_keys_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
